...
exports.PerformanceMetricEntity = void 0;
const MaplestoryEntityBase_1 = require("../MaplestoryEntityBase");
// TODO: needs Entity superclass
class PerformanceMetricEntity extends MaplestoryEntityBase_1.MaplestoryEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'performance_metric';
        this.name_ = 'performance_metric';
        this.Name = 'PerformanceMetric';
    }
    make() {
        return new PerformanceMetricEntity(this._client, this.entopts());
    }
...
//# sourceMappingURL=PerformanceMetricEntity.js.map