...
describe('Wzn2Direct', async () => {
  ...
  test('direct-load-wzn2', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-wzn2', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['MAPLESTORY_TEST_WZN__ENTID']
