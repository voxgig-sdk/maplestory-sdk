...
//     (\`new MaplestorySDK(...)\` / \`MaplestorySDK.test(...)\` become
//     \`MaplestorySDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"android":{"test01":{"id":"test01"}},"avatar":{"test01":{"id":"test01"}},"cache":{"test01":{"id":"test01"}},"character":{"test01":{"id":"test01"}},"chat":{"test01":{"id":"test01"}},"cluster":{"test01":{"id":"test01"}},"diff":{"test01":{"id":"test01"}},"entity1":{"test01":{"id":"test01"}},"gms_new":{"test01":{"id":"test01"}},"guild_mark":{"test01":{"id":"test01"}},"health":{"test01":{"id":"test01"}},"item":{"test01":{"id":"test01"}},"job":{"test01":{"id":"test01"}},"map":{"test01":{"id":"test01"}},"metric":{"test01":{"id":"test01"}},"mob":{"test01":{"id":"test01"}},"music":{"test01":{"id":"test01"}},"name":{"test01":{"id":"test01"}},"npc":{"test01":{"id":"test01"}},"nxf":{"test01":{"id":"test01"}},"performance_metric":{"test01":{"id":"test01"}},"pet":{"test01":{"id":"test01"}},"quest":{"test01":{"id":"test01"}},"system":{"test01":{"id":"test01"}},"tip":{"test01":{"id":"test01"}},"wzn":{"test01":{"id":"test01"}},"wzn2":{"test01":{"id":"test01"}},"wzn3":{"test01":{"id":"test01"}},"wzn4":{"test01":{"id":"test01"}},"wzn5":{"test01":{"id":"test01"}},"wzn6":{"test01":{"id":"test01"}},"z_map":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new MaplestorySDK(...)\` and any
// \`MaplestorySDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+MaplestorySDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/MaplestorySDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
