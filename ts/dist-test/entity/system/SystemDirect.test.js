...
(0, node_test_1.describe)('SystemDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-system', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-system', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MAPLESTORY_TEST_SYSTEM_ENTID'];
...
//# sourceMappingURL=SystemDirect.test.js.map