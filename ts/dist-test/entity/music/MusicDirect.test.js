...
(0, node_test_1.describe)('MusicDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-music', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-music', setup.live))
            return;
        ...
        const result = await client.direct({
            path: 'api/{region}/{version}/music/{id}',
            method: 'GET',
            params,
            query,
        });
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MAPLESTORY_TEST_MUSIC_ENTID'];
