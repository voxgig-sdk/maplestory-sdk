...
(0, node_test_1.describe)('MobDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-mob', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-mob', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MAPLESTORY_TEST_MOB_ENTID'];
...
//# sourceMappingURL=MobDirect.test.js.map