...
(0, node_test_1.describe)('JobDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-job', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-job', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["id01", "region01", "skill_id01", "version01"]))
            return;
        ...
        if (setup.live) {
            ...
            params.skill_id = 'direct03';
            params.version = 'direct04';
        }
        const result = await client.direct({
            path: 'api/{region}/{version}/job/{id}/skillbook/{skill_id}',
            method: 'GET',
            params,
            query,
        });
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MAPLESTORY_TEST_JOB_ENTID'];
