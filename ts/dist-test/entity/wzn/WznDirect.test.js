...
(0, node_test_1.describe)('WznDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-wzn', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-wzn', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["path01", "region01", "version01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MAPLESTORY_TEST_WZN_ENTID'];
...
//# sourceMappingURL=WznDirect.test.js.map