...
(0, node_test_1.describe)('ZMapDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-z_map', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-z_map', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MAPLESTORY_TEST_Z_MAP_ENTID'];
...
//# sourceMappingURL=ZMapDirect.test.js.map