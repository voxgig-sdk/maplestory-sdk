...
(0, node_test_1.describe)('CacheDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-cache', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-cache', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MAPLESTORY_TEST_CACHE_ENTID'];
...
//# sourceMappingURL=CacheDirect.test.js.map