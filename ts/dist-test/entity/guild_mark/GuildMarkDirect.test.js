...
(0, node_test_1.describe)('GuildMarkDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MaplestorySDK({
    ...
    (0, node_test_1.test)('direct-load-guild_mark', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-guild_mark', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["guild_background_color_id01", "guild_background_id01", "guild_mark_color_id01", "guild_mark_id01", "region01", "version01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MaplestorySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['MAPLESTORY_TEST_GUILD_MARK_ENTID'];
    ...
    const client = new __1.MaplestorySDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GuildMarkDirect.test.js.map