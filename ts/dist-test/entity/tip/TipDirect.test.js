...
(0, node_test_1.describe)('TipDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-tip', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-tip', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MAPLESTORY_TEST_TIP_ENTID'];
...
//# sourceMappingURL=TipDirect.test.js.map