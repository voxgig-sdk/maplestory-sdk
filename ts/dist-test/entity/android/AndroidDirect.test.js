...
(0, node_test_1.describe)('AndroidDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-android', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-android', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["id01", "region01", "version01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MAPLESTORY_TEST_ANDROID_ENTID'];
...
//# sourceMappingURL=AndroidDirect.test.js.map