...
(0, node_test_1.describe)('MapDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-map', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-map', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["frame01", "layer01", "map_id01", "region01", "version01"]))
            return;
        ...
        if (setup.live) {
            ...
            params.layer = 'direct02';
            params.map_id = 'direct03';
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MAPLESTORY_TEST_MAP_ENTID'];
