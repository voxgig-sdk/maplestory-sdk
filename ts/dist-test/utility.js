...
function envOverride(m) {
    if ('TRUE' === process.env.MAPLESTORY_TEST_LIVE ||
        'TRUE' === process.env.MAPLESTORY_TEST_OVERRIDE) {
    ...
    m.MAPLESTORY_TEST_EXPLAIN = process.env.MAPLESTORY_TEST_EXPLAIN || m.MAPLESTORY_TEST_EXPLAIN;
    return m;
}
