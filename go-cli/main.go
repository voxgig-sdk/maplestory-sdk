...
const entitiesHelp = "android avatar cache character chat cluster diff entity1 gms_new guild_mark health item job map metric mob music name npc nxf performance_metric pet quest system tip wzn z_map"
