...
// Maplestory SDK clienttrack feature
...
class MaplestoryClienttrackFeature extends MaplestoryBaseFeature
{
    ...
    public function PostConstruct(MaplestoryContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Maplestory-SDK';
