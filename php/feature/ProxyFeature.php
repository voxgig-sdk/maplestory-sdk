...
class MaplestoryProxyFeature extends MaplestoryBaseFeature
{
    ...
    public function init(MaplestoryContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MaplestoryContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
