...
// Maplestory SDK idempotency feature
...
class MaplestoryIdempotencyFeature extends MaplestoryBaseFeature
{
    ...
    private function _mutating(MaplestoryContext $ctx): bool
    {
