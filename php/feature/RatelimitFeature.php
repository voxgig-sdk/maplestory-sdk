...
// Maplestory SDK ratelimit feature
...
class MaplestoryRatelimitFeature extends MaplestoryBaseFeature
{
    ...
    private function _acquire(MaplestoryContext $ctx): void
    {
    ...
    private function _track(MaplestoryContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
