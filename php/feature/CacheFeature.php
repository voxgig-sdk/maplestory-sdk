...
class MaplestoryCacheFeature extends MaplestoryBaseFeature
{
    ...
    private function _through(MaplestoryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
