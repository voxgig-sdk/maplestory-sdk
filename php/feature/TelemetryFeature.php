...
// Maplestory SDK telemetry feature
...
class MaplestoryTelemetryFeature extends MaplestoryBaseFeature
{
    ...
    private function _close(MaplestoryContext $ctx, bool $ok): void
    {
