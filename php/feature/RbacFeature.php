...
class MaplestoryRbacFeature extends MaplestoryBaseFeature
{
    ...
    private function _required(MaplestoryContext $ctx): ?string
    {
    ...
    private function _reject(MaplestoryContext $ctx, string $required): void
    {
    ...
    private function _track(MaplestoryContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
