...
class GmsNewEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GmsNewEntity($this->_client, $opts);
    }

    /**
     * @param GmsNew|array $args GmsNew data (assoc-array) to store.
     */
    ...
    /**
     * @return GmsNew|array The current GmsNew data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GmsNew fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GmsNew fields).
     */
    ...
    /**
     * Load a single GmsNew.
     *
     * @param GmsNewLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GmsNewLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GmsNew|array The loaded GmsNew as an assoc-array at the
