...
class TipEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TipEntity($this->_client, $opts);
    }

    /**
     * @param Tip|array $args Tip data (assoc-array) to store.
     */
    ...
    /**
     * @return Tip|array The current Tip data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Tip fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Tip fields).
     */
     ...
     * Load a single Tip.
     *
     * @param TipLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TipLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Tip|array The loaded Tip as an assoc-array at the
