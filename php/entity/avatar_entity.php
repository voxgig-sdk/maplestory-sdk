...
class AvatarEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AvatarEntity($this->_client, $opts);
    }

    /**
     * @param Avatar|array $args Avatar data (assoc-array) to store.
     */
    ...
    /**
     * @return Avatar|array The current Avatar data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Avatar fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Avatar fields).
     */
    ...
    /**
     * Load a single Avatar.
     *
     * @param AvatarLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AvatarLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Avatar|array The loaded Avatar as an assoc-array at the
