...
class AndroidEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AndroidEntity($this->_client, $opts);
    }

    /**
     * @param Android|array $args Android data (assoc-array) to store.
     */
    ...
    /**
     * @return Android|array The current Android data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Android fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Android fields).
     */
     ...
     *
     * @param AndroidLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AndroidLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Android|array The loaded Android as an assoc-array at the
