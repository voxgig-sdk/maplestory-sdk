...
class ZMapEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ZMapEntity($this->_client, $opts);
    }

    /**
     * @param ZMap|array $args ZMap data (assoc-array) to store.
     */
    ...
    /**
     * @return ZMap|array The current ZMap data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ZMap fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ZMap fields).
     */
     ...
     * Load a single ZMap.
     *
     * @param ZMapLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ZMapLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ZMap|array The loaded ZMap as an assoc-array at the
