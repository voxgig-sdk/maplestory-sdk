...
class GuildMarkDirectTest extends TestCase
{
    public function test_direct_load_guild_mark(): void
    {
        $setup = guild_mark_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-guild_mark", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
