...
class WznDirectTest extends TestCase
{
    public function test_direct_load_wzn(): void
    {
        $setup = wzn_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-wzn", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
