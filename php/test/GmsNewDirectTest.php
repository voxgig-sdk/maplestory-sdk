...
class GmsNewDirectTest extends TestCase
{
    public function test_direct_load_gms_new(): void
    {
        $setup = gms_new_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-gms_new", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
