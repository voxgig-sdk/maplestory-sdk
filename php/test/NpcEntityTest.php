...
class NpcEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MAPLESTORY_TEST_NPC_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function npc_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["npc01", "npc02", "npc03", "api01", "api02", "api03", "animated01", "animated02", "animated03", "render01", "render02", "render03", "region01", "version01"] as $k) {
    ...
    $entid_env_raw = getenv("MAPLESTORY_TEST_NPC_ENTID");
