...
// Maplestory SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MaplestorySDK::test)
...
{
    private const SDK_CLASS = 'MaplestorySDK';
    ...
    private const SDK_BASE = 'maplestory_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../maplestory_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
