...
class Wzn4DirectTest extends TestCase
{
    public function test_direct_load_wzn4(): void
    {
        $setup = wzn4_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-wzn4", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
