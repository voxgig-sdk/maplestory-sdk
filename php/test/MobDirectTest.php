...
class MobDirectTest extends TestCase
{
    public function test_direct_load_mob(): void
    {
        $setup = mob_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-mob", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
