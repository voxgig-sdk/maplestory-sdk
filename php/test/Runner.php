...
class MaplestoryTestRunner
{
    ...
    {
        $live = self::getenv('MAPLESTORY_TEST_LIVE');
        $override = self::getenv('MAPLESTORY_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MAPLESTORY_TEST_EXPLAIN');
...
class_alias('MaplestoryTestRunner', 'Runner');
class_alias('MaplestoryHelpers', 'Helpers');
