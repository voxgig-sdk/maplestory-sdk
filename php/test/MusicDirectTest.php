...
{
    public function test_direct_load_music(): void
    {
        $setup = music_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-music", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
