...
// Maplestory SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MaplestoryOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MaplestoryOmni::structfix($now, Struct::undef()))
                        !== json_encode(MaplestoryOmni::structfix($val, Struct::undef()))) {
