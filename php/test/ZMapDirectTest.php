...
class ZMapDirectTest extends TestCase
{
    public function test_direct_load_z_map(): void
    {
        $setup = z_map_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-z_map", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
