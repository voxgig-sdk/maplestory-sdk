...
class Wzn2DirectTest extends TestCase
{
    public function test_direct_load_wzn2(): void
    {
        $setup = wzn2_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-wzn2", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
