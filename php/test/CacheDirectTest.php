...
class CacheDirectTest extends TestCase
{
    public function test_direct_load_cache(): void
    {
        $setup = cache_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-cache", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
