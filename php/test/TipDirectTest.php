...
class TipDirectTest extends TestCase
{
    public function test_direct_load_tip(): void
    {
        $setup = tip_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-tip", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
