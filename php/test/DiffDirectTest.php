...
class DiffDirectTest extends TestCase
{
    public function test_direct_load_diff(): void
    {
        $setup = diff_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-diff", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
