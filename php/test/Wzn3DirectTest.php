...
class Wzn3DirectTest extends TestCase
{
    public function test_direct_load_wzn3(): void
    {
        $setup = wzn3_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-wzn3", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
