...
class Wzn6DirectTest extends TestCase
{
    public function test_direct_load_wzn6(): void
    {
        $setup = wzn6_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-wzn6", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
