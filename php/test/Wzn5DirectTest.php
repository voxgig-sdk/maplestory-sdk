...
class Wzn5DirectTest extends TestCase
{
    public function test_direct_load_wzn5(): void
    {
        $setup = wzn5_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-wzn5", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
