...
func NewZMapEntity(client *core.MaplestorySDK, entopts map[string]any) *ZMapEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ZMapEntity) GetName() string { return e.name }
...
func (e *ZMapEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ZMapEntity) Deleted() bool {
	return e.deleted
}


func (e *ZMapEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewZMapEntity(e.client, opts)
}

func (e *ZMapEntity) Data(args ...any) any {
...
func (e *ZMapEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ZMap; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ZMapEntity) DataTyped(data ...ZMap) ZMap {
	if len(data) > 0 {
		return typedFrom[ZMap](e.Data(asMap(data[0])))
	}
	return typedFrom[ZMap](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ZMap (all fields
// optional at the wire level).
func (e *ZMapEntity) MatchTyped(match ...ZMap) ZMap {
	if len(match) > 0 {
		return typedFrom[ZMap](e.Match(asMap(match[0])))
	}
	return typedFrom[ZMap](e.Match())
}
...
func (e *ZMapEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ZMapEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ZMapLoadMatch and returns an ZMap. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ZMapEntity) LoadTyped(reqmatch ZMapLoadMatch, ctrl map[string]any) (ZMap, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ZMap{}, err
	}
	return typedFrom[ZMap](res), nil
}



func (e *ZMapEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ZMapEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ZMapEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ZMapEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ZMapEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
