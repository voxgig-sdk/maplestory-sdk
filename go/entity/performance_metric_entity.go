...
type PerformanceMetricEntity struct {
	name    string
...
func NewPerformanceMetricEntity(client *core.MaplestorySDK, entopts map[string]any) *PerformanceMetricEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PerformanceMetricEntity) GetName() string { return e.name }
...
func (e *PerformanceMetricEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PerformanceMetricEntity) Deleted() bool {
	return e.deleted
}


func (e *PerformanceMetricEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPerformanceMetricEntity(e.client, opts)
}

func (e *PerformanceMetricEntity) Data(args ...any) any {
...
func (e *PerformanceMetricEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PerformanceMetric; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PerformanceMetricEntity) DataTyped(data ...PerformanceMetric) PerformanceMetric {
	if len(data) > 0 {
		return typedFrom[PerformanceMetric](e.Data(asMap(data[0])))
	}
	return typedFrom[PerformanceMetric](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PerformanceMetric (all fields
// optional at the wire level).
func (e *PerformanceMetricEntity) MatchTyped(match ...PerformanceMetric) PerformanceMetric {
	if len(match) > 0 {
		return typedFrom[PerformanceMetric](e.Match(asMap(match[0])))
	}
	return typedFrom[PerformanceMetric](e.Match())
}
...
func (e *PerformanceMetricEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PerformanceMetricEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PerformanceMetricLoadMatch and returns an PerformanceMetric. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PerformanceMetricEntity) LoadTyped(reqmatch PerformanceMetricLoadMatch, ctrl map[string]any) (PerformanceMetric, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PerformanceMetric{}, err
	}
	return typedFrom[PerformanceMetric](res), nil
}



func (e *PerformanceMetricEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PerformanceMetricEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PerformanceMetricEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PerformanceMetricEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PerformanceMetricEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
