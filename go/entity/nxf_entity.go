...
func NewNxfEntity(client *core.MaplestorySDK, entopts map[string]any) *NxfEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NxfEntity) GetName() string { return e.name }
...
func (e *NxfEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NxfEntity) Deleted() bool {
	return e.deleted
}


func (e *NxfEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNxfEntity(e.client, opts)
}

func (e *NxfEntity) Data(args ...any) any {
...
func (e *NxfEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Nxf; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NxfEntity) DataTyped(data ...Nxf) Nxf {
	if len(data) > 0 {
		return typedFrom[Nxf](e.Data(asMap(data[0])))
	}
	return typedFrom[Nxf](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Nxf (all fields
// optional at the wire level).
func (e *NxfEntity) MatchTyped(match ...Nxf) Nxf {
	if len(match) > 0 {
		return typedFrom[Nxf](e.Match(asMap(match[0])))
	}
	return typedFrom[Nxf](e.Match())
}
...
func (e *NxfEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NxfEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NxfLoadMatch and returns an Nxf. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NxfEntity) LoadTyped(reqmatch NxfLoadMatch, ctrl map[string]any) (Nxf, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Nxf{}, err
	}
	return typedFrom[Nxf](res), nil
}



func (e *NxfEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NxfEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NxfEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NxfEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NxfEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
