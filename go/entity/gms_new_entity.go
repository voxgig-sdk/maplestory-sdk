...
func NewGmsNewEntity(client *core.MaplestorySDK, entopts map[string]any) *GmsNewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GmsNewEntity) GetName() string { return e.name }
...
func (e *GmsNewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GmsNewEntity) Deleted() bool {
	return e.deleted
}


func (e *GmsNewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGmsNewEntity(e.client, opts)
}

func (e *GmsNewEntity) Data(args ...any) any {
...
func (e *GmsNewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GmsNewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GmsNewEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GmsNewEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GmsNewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GmsNewEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GmsNewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
