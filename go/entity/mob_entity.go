...
func NewMobEntity(client *core.MaplestorySDK, entopts map[string]any) *MobEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MobEntity) GetName() string { return e.name }
...
func (e *MobEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MobEntity) Deleted() bool {
	return e.deleted
}


func (e *MobEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMobEntity(e.client, opts)
}

func (e *MobEntity) Data(args ...any) any {
...
func (e *MobEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Mob; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MobEntity) DataTyped(data ...Mob) Mob {
	if len(data) > 0 {
		return typedFrom[Mob](e.Data(asMap(data[0])))
	}
	return typedFrom[Mob](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Mob (all fields
// optional at the wire level).
func (e *MobEntity) MatchTyped(match ...Mob) Mob {
	if len(match) > 0 {
		return typedFrom[Mob](e.Match(asMap(match[0])))
	}
	return typedFrom[Mob](e.Match())
}
...
func (e *MobEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MobEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MobLoadMatch and returns an Mob. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MobEntity) LoadTyped(reqmatch MobLoadMatch, ctrl map[string]any) (Mob, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Mob{}, err
	}
	return typedFrom[Mob](res), nil
}



func (e *MobEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MobEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MobEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MobEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MobEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
