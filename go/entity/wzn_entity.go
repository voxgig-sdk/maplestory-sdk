...
func NewWznEntity(client *core.MaplestorySDK, entopts map[string]any) *WznEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WznEntity) GetName() string { return e.name }
...
func (e *WznEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WznEntity) Deleted() bool {
	return e.deleted
}


func (e *WznEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWznEntity(e.client, opts)
}

func (e *WznEntity) Data(args ...any) any {
...
func (e *WznEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Wzn; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WznEntity) DataTyped(data ...Wzn) Wzn {
	if len(data) > 0 {
		return typedFrom[Wzn](e.Data(asMap(data[0])))
	}
	return typedFrom[Wzn](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Wzn (all fields
// optional at the wire level).
func (e *WznEntity) MatchTyped(match ...Wzn) Wzn {
	if len(match) > 0 {
		return typedFrom[Wzn](e.Match(asMap(match[0])))
	}
	return typedFrom[Wzn](e.Match())
}
...
func (e *WznEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WznEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WznLoadMatch and returns an Wzn. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WznEntity) LoadTyped(reqmatch WznLoadMatch, ctrl map[string]any) (Wzn, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Wzn{}, err
	}
	return typedFrom[Wzn](res), nil
}



func (e *WznEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WznEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WznEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WznEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WznEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
