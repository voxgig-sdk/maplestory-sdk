...
func NewDiffEntity(client *core.MaplestorySDK, entopts map[string]any) *DiffEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DiffEntity) GetName() string { return e.name }
...
func (e *DiffEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DiffEntity) Deleted() bool {
	return e.deleted
}


func (e *DiffEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDiffEntity(e.client, opts)
}

func (e *DiffEntity) Data(args ...any) any {
...
func (e *DiffEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Diff; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DiffEntity) DataTyped(data ...Diff) Diff {
	if len(data) > 0 {
		return typedFrom[Diff](e.Data(asMap(data[0])))
	}
	return typedFrom[Diff](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Diff (all fields
// optional at the wire level).
func (e *DiffEntity) MatchTyped(match ...Diff) Diff {
	if len(match) > 0 {
		return typedFrom[Diff](e.Match(asMap(match[0])))
	}
	return typedFrom[Diff](e.Match())
}
...
func (e *DiffEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DiffEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DiffLoadMatch and returns an Diff. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DiffEntity) LoadTyped(reqmatch DiffLoadMatch, ctrl map[string]any) (Diff, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Diff{}, err
	}
	return typedFrom[Diff](res), nil
}



func (e *DiffEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DiffEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DiffEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DiffEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DiffEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
