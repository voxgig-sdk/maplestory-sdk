...
func NewMetricEntity(client *core.MaplestorySDK, entopts map[string]any) *MetricEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MetricEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MetricEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MetricEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MetricEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
