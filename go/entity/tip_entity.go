...
func NewTipEntity(client *core.MaplestorySDK, entopts map[string]any) *TipEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TipEntity) GetName() string { return e.name }
...
func (e *TipEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TipEntity) Deleted() bool {
	return e.deleted
}


func (e *TipEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTipEntity(e.client, opts)
}

func (e *TipEntity) Data(args ...any) any {
...
func (e *TipEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *TipEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TipEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TipEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TipEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TipEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TipEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
