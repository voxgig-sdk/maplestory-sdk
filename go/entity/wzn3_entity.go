...
func NewWzn3Entity(client *core.MaplestorySDK, entopts map[string]any) *Wzn3Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Wzn3Entity) GetName() string { return e.name }

func (e *Wzn3Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWzn3Entity(e.client, opts)
}

func (e *Wzn3Entity) Data(args ...any) any {
...
func (e *Wzn3Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *Wzn3Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Wzn3Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *Wzn3Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Wzn3Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Wzn3Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Wzn3Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
