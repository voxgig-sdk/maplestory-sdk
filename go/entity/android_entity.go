...
func NewAndroidEntity(client *core.MaplestorySDK, entopts map[string]any) *AndroidEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AndroidEntity) GetName() string { return e.name }
...
func (e *AndroidEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AndroidEntity) Deleted() bool {
	return e.deleted
}


func (e *AndroidEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAndroidEntity(e.client, opts)
}

func (e *AndroidEntity) Data(args ...any) any {
...
func (e *AndroidEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Android; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AndroidEntity) DataTyped(data ...Android) Android {
	if len(data) > 0 {
		return typedFrom[Android](e.Data(asMap(data[0])))
	}
	return typedFrom[Android](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Android (all fields
// optional at the wire level).
func (e *AndroidEntity) MatchTyped(match ...Android) Android {
	if len(match) > 0 {
		return typedFrom[Android](e.Match(asMap(match[0])))
	}
	return typedFrom[Android](e.Match())
}
...
func (e *AndroidEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AndroidEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AndroidLoadMatch and returns an Android. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AndroidEntity) LoadTyped(reqmatch AndroidLoadMatch, ctrl map[string]any) (Android, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Android{}, err
	}
	return typedFrom[Android](res), nil
}



func (e *AndroidEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AndroidEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AndroidEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AndroidEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AndroidEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
