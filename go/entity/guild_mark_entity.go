...
func NewGuildMarkEntity(client *core.MaplestorySDK, entopts map[string]any) *GuildMarkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GuildMarkEntity) GetName() string { return e.name }
...
func (e *GuildMarkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GuildMarkEntity) Deleted() bool {
	return e.deleted
}


func (e *GuildMarkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGuildMarkEntity(e.client, opts)
}

func (e *GuildMarkEntity) Data(args ...any) any {
...
func (e *GuildMarkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GuildMark; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GuildMarkEntity) DataTyped(data ...GuildMark) GuildMark {
	if len(data) > 0 {
		return typedFrom[GuildMark](e.Data(asMap(data[0])))
	}
	return typedFrom[GuildMark](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GuildMark (all fields
// optional at the wire level).
func (e *GuildMarkEntity) MatchTyped(match ...GuildMark) GuildMark {
	if len(match) > 0 {
		return typedFrom[GuildMark](e.Match(asMap(match[0])))
	}
	return typedFrom[GuildMark](e.Match())
}
...
func (e *GuildMarkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GuildMarkEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GuildMarkLoadMatch and returns an GuildMark. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GuildMarkEntity) LoadTyped(reqmatch GuildMarkLoadMatch, ctrl map[string]any) (GuildMark, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GuildMark{}, err
	}
	return typedFrom[GuildMark](res), nil
}



func (e *GuildMarkEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GuildMarkEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GuildMarkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GuildMarkEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GuildMarkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
