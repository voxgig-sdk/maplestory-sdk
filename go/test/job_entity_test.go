...
func jobBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap := vs.Transform(
		[]any{"job01", "job02", "job03", "api01", "api02", "api03", "skill01", "skill02", "skill03", "skillbook01", "skillbook02", "skillbook03", "region01"},
		map[string]any{
	...
	entidEnvRaw := os.Getenv("MAPLESTORY_TEST_JOB_ENTID")
	...
	idmapResolved := core.ToMapAny(env["MAPLESTORY_TEST_JOB_ENTID"])
