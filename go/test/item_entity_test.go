...
func itemBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap := vs.Transform(
		[]any{"item01", "item02", "item03", "api01", "api02", "api03", "category01", "category02", "category03", "region01"},
		map[string]any{
	...
	entidEnvRaw := os.Getenv("MAPLESTORY_TEST_ITEM_ENTID")
	...
	idmapResolved := core.ToMapAny(env["MAPLESTORY_TEST_ITEM_ENTID"])
