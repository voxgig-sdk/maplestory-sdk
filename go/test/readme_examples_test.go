...
const testSeed = `map[string]any{"entity": map[string]any{"android": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "avatar": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cache": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "chat": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cluster": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "diff": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "entity1": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "gms_new": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "guild_mark": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "health": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "job": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "map": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "metric": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mob": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "music": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "name": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "npc": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "nxf": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "performance_metric": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pet": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "quest": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "system": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tip": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "wzn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "wzn2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "wzn3": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "wzn4": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "wzn5": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "wzn6": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "z_map": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
