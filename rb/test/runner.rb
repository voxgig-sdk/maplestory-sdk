...
module MaplestoryTestRunner
  ...
  def self.env_override(m)
    live = getenv("MAPLESTORY_TEST_LIVE")
    override = getenv("MAPLESTORY_TEST_OVERRIDE")
    ...
    explain = getenv("MAPLESTORY_TEST_EXPLAIN")
    m["MAPLESTORY_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = MaplestoryTestRunner
Helpers = MaplestoryHelpers
Vs = VoxgigStruct
