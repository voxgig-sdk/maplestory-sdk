...
class PetEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MAPLESTORY_TEST_PET_ENTID JSON to run live"
      return
    end
    client = setup[:client]
    ...
    pet_ref01_data = nil
    if pet_ref01_data_raw.length > 0
...
def pet_basic_setup(extra)
  ...
  entid_env_raw = ENV["MAPLESTORY_TEST_PET_ENTID"]
