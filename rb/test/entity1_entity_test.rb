...
class Entity1EntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MAPLESTORY_TEST_ENTITY__ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def entity1_basic_setup(extra)
  ...
  entid_env_raw = ENV["MAPLESTORY_TEST_ENTITY__ENTID"]
