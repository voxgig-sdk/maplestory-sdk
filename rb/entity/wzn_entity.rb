...
class WznEntity
  ...
  # @return [Wzn, Hash] the current Wzn data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Wzn fields)
  def match_get
  ...
  # Load a single Wzn.
  #
  # @param reqmatch [WznLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Wzn.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Wzn, Hash] the loaded Wzn; raises MaplestoryError on failure
