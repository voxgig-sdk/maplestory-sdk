...
class ZMapEntity
  ...
  # @return [ZMap, Hash] the current ZMap data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ZMap fields)
  def match_get
  ...
  # Load a single ZMap.
  #
  # @param reqmatch [ZMapLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ZMap.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ZMap, Hash] the loaded ZMap; raises MaplestoryError on failure
