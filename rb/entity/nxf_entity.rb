...
class NxfEntity
  ...
  # @return [Nxf, Hash] the current Nxf data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Nxf fields)
  def match_get
  ...
  # Load a single Nxf.
  #
  # @param reqmatch [NxfLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Nxf.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Nxf, Hash] the loaded Nxf; raises MaplestoryError on failure
