...
class MobEntity
  ...
  # @return [Mob, Hash] the current Mob data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Mob fields)
  def match_get
  ...
  # Load a single Mob.
  #
  # @param reqmatch [MobLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Mob.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Mob, Hash] the loaded Mob; raises MaplestoryError on failure
