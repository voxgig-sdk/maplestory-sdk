...
class ClusterEntity
  ...
  #
  # @param reqmatch [ClusterListMatch, Hash, nil] match filter (any subset of
  #   Cluster fields); defaults to nil, treated as an empty match that lists all.
