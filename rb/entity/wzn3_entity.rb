...
class Wzn3Entity
  ...
  # @return [Wzn3, Hash] the current Wzn3 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Wzn3 fields)
  def match_get
  ...
  # Load a single Wzn3.
  #
  # @param reqmatch [Wzn3LoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Wzn3.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Wzn3, Hash] the loaded Wzn3; raises MaplestoryError on failure
