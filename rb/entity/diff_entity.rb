...
class DiffEntity
  ...
  # @return [Diff, Hash] the current Diff data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Diff fields)
  def match_get
  ...
  # Load a single Diff.
  #
  # @param reqmatch [DiffLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Diff.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Diff, Hash] the loaded Diff; raises MaplestoryError on failure
