...
class Wzn2Entity
  ...
  # @return [Wzn2, Hash] the current Wzn2 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Wzn2 fields)
  def match_get
  ...
  # Load a single Wzn2.
  #
  # @param reqmatch [Wzn2LoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Wzn2.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Wzn2, Hash] the loaded Wzn2; raises MaplestoryError on failure
