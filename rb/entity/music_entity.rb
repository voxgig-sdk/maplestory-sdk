...
class MusicEntity
  ...
  # Load a single Music.
  #
  # @param reqmatch [MusicLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Music.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Music, Hash] the loaded Music; raises MaplestoryError on failure
