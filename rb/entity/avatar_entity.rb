...
class AvatarEntity
  ...
  # @return [Avatar, Hash] the current Avatar data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Avatar fields)
  def match_get
  ...
  #
  # @param reqmatch [AvatarLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Avatar.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Avatar, Hash] the loaded Avatar; raises MaplestoryError on failure
