...
class Wzn6Entity
  ...
  # @return [Wzn6, Hash] the current Wzn6 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Wzn6 fields)
  def match_get
  ...
  # Load a single Wzn6.
  #
  # @param reqmatch [Wzn6LoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Wzn6.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Wzn6, Hash] the loaded Wzn6; raises MaplestoryError on failure
