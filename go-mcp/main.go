// Command Maplestory-mcp is an MCP server exposing the Maplestory
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Maplestory_list  — list records of an entity
//	Maplestory_load  — load a single record of an entity
//
