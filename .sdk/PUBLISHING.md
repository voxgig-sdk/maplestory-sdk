...
|---|---|---|
| `ts/` | @voxgig-sdk/maplestory-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/maplestory-sdk \
      --repository voxgig-sdk/maplestory-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/maplestory-sdk` shows it, and
`npm trust revoke @voxgig-sdk/maplestory-sdk --id=<id>` removes it.
