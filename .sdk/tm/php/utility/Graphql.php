...
// Maplestory SDK utility: graphql
//
...
class MaplestoryGraphql
{
    ...
    // equivalent.
    public static function body(MaplestoryContext $ctx): mixed
    {
    ...
    public static function errors(MaplestoryContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
