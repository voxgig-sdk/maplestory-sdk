...
// Maplestory SDK utility: fetcher

class MaplestoryFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MaplestorySDK/1.0)';
    ...
    public static function call(MaplestoryContext $ctx, string $fullurl, array $fetchdef): array
    {
