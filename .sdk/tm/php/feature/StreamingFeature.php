...
// Maplestory SDK streaming feature
...
class MaplestoryStreamingFeature extends MaplestoryBaseFeature
{
    ...
    private function _iterate(MaplestoryResult $result): \Generator
    {
    ...
    private function _streamable(MaplestoryContext $ctx): bool
    {
