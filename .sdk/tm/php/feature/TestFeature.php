...
// Maplestory SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MaplestoryTestFeature extends MaplestoryBaseFeature
{
    ...
    public function init(MaplestoryContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MaplestoryContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MaplestoryParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MaplestoryContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MaplestoryContext $ctx, $op, $args): array
    {
