...
// Maplestory SDK timeout feature
...
class MaplestoryTimeoutFeature extends MaplestoryBaseFeature
{
    ...
    private function _with_timeout(MaplestoryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MaplestoryContext $_ctx, float $ms): void
    {
        $client = $this->client;
