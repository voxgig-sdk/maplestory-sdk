...
from projectname_sdk.core.control import MaplestoryControl
...
class MaplestoryContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, MaplestorySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MaplestoryResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MaplestoryResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MaplestoryError(code, msg, self)
