...
from projectname_sdk import MaplestorySDK
from projectname_sdk.core.spec import MaplestorySpec
from projectname_sdk.core.result import MaplestoryResult
from projectname_sdk.core.response import MaplestoryResponse
from projectname_sdk.core.operation import MaplestoryOperation
from projectname_sdk.core.error import MaplestoryError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import MaplestoryBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return MaplestoryError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = MaplestorySDK.test(None, None)
        ...
        class TestInitFeature(MaplestoryBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MaplestoryBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MaplestorySpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MaplestorySDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MaplestorySDK.test(None, setup_opts)
