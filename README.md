...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/maplestory` | `npm install @voxgig-sdk/maplestory` |
| Python | `voxgig-sdk-maplestory` | `pip install voxgig-sdk-maplestory` |
| PHP | `voxgig-sdk/maplestory` | `composer require voxgig-sdk/maplestory` |
| Golang | `github.com/voxgig-sdk/maplestory-sdk/go` | `go get github.com/voxgig-sdk/maplestory-sdk/go` |
| Ruby | `voxgig-sdk-maplestory` | `gem install voxgig-sdk-maplestory` |
| Lua | `voxgig-sdk-maplestory` | `luarocks install voxgig-sdk-maplestory` |
