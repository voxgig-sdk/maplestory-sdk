...
from maplestory_sdk.maplestory_types import (
    PerformanceMetric,
...
class PerformanceMetricEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PerformanceMetricEntity(self._client, opts)
    ...
    def data_get(self) -> PerformanceMetric:
    ...
    def match_get(self) -> PerformanceMetric:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PerformanceMetric:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PerformanceMetric().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
