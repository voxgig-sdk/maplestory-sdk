...
class TestMobDirect:
    ...
    def test_should_direct_load_mob(self):
        setup = _mob_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-mob", "live" if setup["live"] else "unit")
        if _skip:
