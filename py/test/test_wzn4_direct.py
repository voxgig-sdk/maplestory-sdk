...
class TestWzn4Direct:

    def test_should_direct_load_wzn4(self):
        setup = _wzn4_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-wzn4", "live" if setup["live"] else "unit")
        if _skip:
...
def _wzn4_direct_setup(mockres):
