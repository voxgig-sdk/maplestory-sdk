...
class TestTipDirect:
    ...
    def test_should_direct_load_tip(self):
        setup = _tip_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-tip", "live" if setup["live"] else "unit")
        if _skip:
