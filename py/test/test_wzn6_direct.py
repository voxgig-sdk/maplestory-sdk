...
class TestWzn6Direct:

    def test_should_direct_load_wzn6(self):
        setup = _wzn6_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-wzn6", "live" if setup["live"] else "unit")
        if _skip:
...
def _wzn6_direct_setup(mockres):
