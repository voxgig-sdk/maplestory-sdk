...
class TestWzn3Direct:

    def test_should_direct_load_wzn3(self):
        setup = _wzn3_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-wzn3", "live" if setup["live"] else "unit")
        if _skip:
...
def _wzn3_direct_setup(mockres):
