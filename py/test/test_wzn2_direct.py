...
class TestWzn2Direct:

    def test_should_direct_load_wzn2(self):
        setup = _wzn2_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-wzn2", "live" if setup["live"] else "unit")
        if _skip:
...
def _wzn2_direct_setup(mockres):
