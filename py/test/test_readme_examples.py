# Maplestory SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MaplestorySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MaplestorySDK(...) and MaplestorySDK.test(...) become
#      MaplestorySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "maplestory_sdk"
_SDK_CLASS = "MaplestorySDK"
