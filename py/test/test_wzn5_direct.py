...
class TestWzn5Direct:

    def test_should_direct_load_wzn5(self):
        setup = _wzn5_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-wzn5", "live" if setup["live"] else "unit")
        if _skip:
...
def _wzn5_direct_setup(mockres):
