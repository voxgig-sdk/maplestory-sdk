...
local Wzn5Entity = {}
Wzn5Entity.__index = Wzn5Entity


function Wzn5Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Wzn5Entity)
  self._name = "wzn5"
  self._client = client
...
function Wzn5Entity:get_name()
  return self._name
end


function Wzn5Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Wzn5Entity.new(self._client, opts)
end


function Wzn5Entity:data_set(args)
  if args ~= nil then
...
function Wzn5Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Wzn5Entity:match_set(args)
  if args ~= nil then
...
function Wzn5Entity:stream(action, args, callopts)
...
---@param reqmatch Wzn5LoadMatch
---@param ctrl? table
---@return Wzn5
---@return string? err
function Wzn5Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function Wzn5Entity:_run_op(ctx, post_done)
  local utility = self._utility
