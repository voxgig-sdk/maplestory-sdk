...
local WznEntity = {}
WznEntity.__index = WznEntity


function WznEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WznEntity)
  self._name = "wzn"
  self._client = client
...
function WznEntity:get_name()
  return self._name
end


function WznEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WznEntity.new(self._client, opts)
end
...
function WznEntity:mark_deleted()
  self._deleted = true
end


function WznEntity:deleted()
  return true == self._deleted
end


function WznEntity:data_set(args)
  if args ~= nil then
...
function WznEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WznEntity:match_set(args)
  if args ~= nil then
...
function WznEntity:stream(action, args, callopts)
...
---@param reqmatch WznLoadMatch
---@param ctrl? table
---@return Wzn
---@return string? err
function WznEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function WznEntity:_run_op(ctx, post_done)
  local utility = self._utility
