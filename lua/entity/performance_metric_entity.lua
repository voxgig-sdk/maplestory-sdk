...
local PerformanceMetricEntity = {}
PerformanceMetricEntity.__index = PerformanceMetricEntity


function PerformanceMetricEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PerformanceMetricEntity)
  self._name = "performance_metric"
  self._client = client
...
function PerformanceMetricEntity:get_name()
  return self._name
end


function PerformanceMetricEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PerformanceMetricEntity.new(self._client, opts)
end
...
function PerformanceMetricEntity:mark_deleted()
  self._deleted = true
end


function PerformanceMetricEntity:deleted()
  return true == self._deleted
end


function PerformanceMetricEntity:data_set(args)
  if args ~= nil then
...
function PerformanceMetricEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PerformanceMetricEntity:match_set(args)
  if args ~= nil then
...
function PerformanceMetricEntity:match_get()
...
function PerformanceMetricEntity:stream(action, args, callopts)
...
function PerformanceMetricEntity:_run_op(ctx, post_done)
  local utility = self._utility
