...
local Wzn6Entity = {}
Wzn6Entity.__index = Wzn6Entity


function Wzn6Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Wzn6Entity)
  self._name = "wzn6"
  self._client = client
...
function Wzn6Entity:get_name()
  return self._name
end


function Wzn6Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Wzn6Entity.new(self._client, opts)
end


function Wzn6Entity:data_set(args)
  if args ~= nil then
...
function Wzn6Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Wzn6Entity:match_set(args)
  if args ~= nil then
...
function Wzn6Entity:stream(action, args, callopts)
...
---@param reqmatch Wzn6LoadMatch
---@param ctrl? table
---@return Wzn6
---@return string? err
function Wzn6Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function Wzn6Entity:_run_op(ctx, post_done)
  local utility = self._utility
