...
local Wzn3Entity = {}
Wzn3Entity.__index = Wzn3Entity


function Wzn3Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Wzn3Entity)
  self._name = "wzn3"
  self._client = client
...
function Wzn3Entity:get_name()
  return self._name
end


function Wzn3Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Wzn3Entity.new(self._client, opts)
end


function Wzn3Entity:data_set(args)
  if args ~= nil then
...
function Wzn3Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Wzn3Entity:match_set(args)
  if args ~= nil then
...
function Wzn3Entity:stream(action, args, callopts)
...
---@param reqmatch Wzn3LoadMatch
---@param ctrl? table
---@return Wzn3
---@return string? err
function Wzn3Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function Wzn3Entity:_run_op(ctx, post_done)
  local utility = self._utility
