...
local Wzn4Entity = {}
Wzn4Entity.__index = Wzn4Entity


function Wzn4Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Wzn4Entity)
  self._name = "wzn4"
  self._client = client
...
function Wzn4Entity:get_name()
  return self._name
end


function Wzn4Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Wzn4Entity.new(self._client, opts)
end


function Wzn4Entity:data_set(args)
  if args ~= nil then
...
function Wzn4Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Wzn4Entity:match_set(args)
  if args ~= nil then
...
function Wzn4Entity:stream(action, args, callopts)
...
---@param reqmatch Wzn4LoadMatch
---@param ctrl? table
---@return Wzn4
---@return string? err
function Wzn4Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function Wzn4Entity:_run_op(ctx, post_done)
  local utility = self._utility
