...
local Wzn2Entity = {}
Wzn2Entity.__index = Wzn2Entity


function Wzn2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Wzn2Entity)
  self._name = "wzn2"
  self._client = client
...
function Wzn2Entity:get_name()
  return self._name
end


function Wzn2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Wzn2Entity.new(self._client, opts)
end


function Wzn2Entity:data_set(args)
  if args ~= nil then
...
function Wzn2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Wzn2Entity:match_set(args)
  if args ~= nil then
...
function Wzn2Entity:stream(action, args, callopts)
...
function Wzn2Entity:_run_op(ctx, post_done)
  local utility = self._utility
