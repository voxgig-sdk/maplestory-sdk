...
describe("AndroidDirect", function()
  it("should direct-load-android", function()
    local setup = android_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-android", setup.live and "live" or "unit")
...
function android_direct_setup(mockres)
