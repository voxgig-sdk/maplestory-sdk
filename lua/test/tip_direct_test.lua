...
describe("TipDirect", function()
  it("should direct-load-tip", function()
    local setup = tip_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-tip", setup.live and "live" or "unit")
...
function tip_direct_setup(mockres)
