...
describe("CacheDirect", function()
  it("should direct-load-cache", function()
    local setup = cache_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-cache", setup.live and "live" or "unit")
...
function cache_direct_setup(mockres)
