...
describe("Wzn2Direct", function()
  it("should direct-load-wzn2", function()
    local setup = wzn2_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-wzn2", setup.live and "live" or "unit")
...
function wzn2_direct_setup(mockres)
