...
describe("Wzn5Direct", function()
  it("should direct-load-wzn5", function()
    local setup = wzn5_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-wzn5", setup.live and "live" or "unit")
...
function wzn5_direct_setup(mockres)
