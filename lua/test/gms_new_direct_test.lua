...
describe("GmsNewDirect", function()
  it("should direct-load-gms_new", function()
    local setup = gms_new_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-gms_new", setup.live and "live" or "unit")
...
function gms_new_direct_setup(mockres)
