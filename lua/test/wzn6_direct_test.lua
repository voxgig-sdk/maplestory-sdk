...
describe("Wzn6Direct", function()
  it("should direct-load-wzn6", function()
    local setup = wzn6_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-wzn6", setup.live and "live" or "unit")
...
function wzn6_direct_setup(mockres)
