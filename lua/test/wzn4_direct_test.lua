...
describe("Wzn4Direct", function()
  it("should direct-load-wzn4", function()
    local setup = wzn4_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-wzn4", setup.live and "live" or "unit")
...
function wzn4_direct_setup(mockres)
