...
describe("Wzn3Direct", function()
  it("should direct-load-wzn3", function()
    local setup = wzn3_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-wzn3", setup.live and "live" or "unit")
...
function wzn3_direct_setup(mockres)
