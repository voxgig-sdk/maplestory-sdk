...
describe("GuildMarkDirect", function()
  it("should direct-load-guild_mark", function()
    local setup = guild_mark_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-guild_mark", setup.live and "live" or "unit")
...
function guild_mark_direct_setup(mockres)
