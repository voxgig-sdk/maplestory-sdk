...
describe("MusicDirect", function()
  it("should direct-load-music", function()
    local setup = music_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-music", setup.live and "live" or "unit")
