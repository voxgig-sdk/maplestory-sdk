...
describe("NxfDirect", function()
  it("should direct-load-nxf", function()
    local setup = nxf_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-nxf", setup.live and "live" or "unit")
...
function nxf_direct_setup(mockres)
