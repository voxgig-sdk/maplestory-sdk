...
describe("ZMapDirect", function()
  it("should direct-load-z_map", function()
    local setup = z_map_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-z_map", setup.live and "live" or "unit")
...
function z_map_direct_setup(mockres)
