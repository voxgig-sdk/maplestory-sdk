...
describe("MapEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MAPLESTORY_TEST_MAP_ENTID JSON to run live")
      return
    end
...
function map_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MAPLESTORY_TEST_MAP_ENTID")
