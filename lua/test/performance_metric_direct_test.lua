...
describe("PerformanceMetricDirect", function()
  it("should direct-load-performance_metric", function()
    local setup = performance_metric_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-performance_metric", setup.live and "live" or "unit")
...
function performance_metric_direct_setup(mockres)
