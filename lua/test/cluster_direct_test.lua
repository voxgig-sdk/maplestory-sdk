...
describe("ClusterDirect", function()
  it("should direct-list-cluster", function()
    local setup = cluster_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cluster", setup.live and "live" or "unit")
...
function cluster_direct_setup(mockres)
