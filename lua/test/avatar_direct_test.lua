...
describe("AvatarDirect", function()
  it("should direct-load-avatar", function()
    local setup = avatar_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-avatar", setup.live and "live" or "unit")
...
function avatar_direct_setup(mockres)
