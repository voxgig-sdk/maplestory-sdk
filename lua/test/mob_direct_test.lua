...
describe("MobDirect", function()
  it("should direct-load-mob", function()
    local setup = mob_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-mob", setup.live and "live" or "unit")
...
function mob_direct_setup(mockres)
